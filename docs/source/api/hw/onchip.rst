...
Additionally, on-chip allocations follow traditional software scoping rules. An allocation
done within the scope of a @Controller, for example, logically creates a new memory on each
